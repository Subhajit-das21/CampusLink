          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass-card rounded-[3rem] p-8 border-white/80 dark:border-white/5 dark:bg-slate-900/40 shadow-2xl relative overflow-hidden transition-all duration-500">
              ...
              <div className="text-center mb-10">
                <div className="w-24 h-24 mx-auto bg-gradient-to-br from-campus-navy to-slate-800 rounded-[2rem] flex items-center justify-center text-white text-4xl font-black shadow-xl mb-6 border-4 border-white dark:border-slate-800 transform hover:rotate-3 transition-transform">
                  S
                </div>
                <h2 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight mb-1">Satyam Mondal</h2>
                <p className="text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-widest mb-6">Verified Student</p>
                <div className="inline-flex items-center gap-2 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 px-4 py-2 rounded-xl text-[10px] font-bold text-slate-500 dark:text-slate-400 transition-colors">
                  <span className="text-campus-teal">📧</span> student@campus.edu
                </div>
              </div>

              {/* High-Impact Stats */}
              <div className="space-y-3">
                <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-500 mb-4 italic">Activity Metrics</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-slate-50/50 dark:bg-white/5 p-5 rounded-2xl border border-slate-100 dark:border-white/5 text-center transition-colors">
                    <p className="text-3xl font-black text-campus-teal leading-none mb-1">{reportsData.length}</p>
            ...
            <button className="w-full bg-white dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 p-5 rounded-[2rem] flex items-center justify-center gap-3 text-red-500 font-black uppercase tracking-widest text-[10px] hover:bg-red-50 dark:hover:bg-red-500/20 transition-all active:scale-95 group shadow-sm">
              <span className="group-hover:rotate-12 transition-transform">🚪</span> Sign Out of Account
            </button>
          </div>
          ...
          <div className="lg:col-span-8">
            <div className="glass-card rounded-[3.5rem] p-8 md:p-12 border-white/80 dark:border-white/5 dark:bg-slate-900/40 shadow-2xl min-h-[600px] transition-all duration-500">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
                <div>
                  <h3 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic">My Active Reports</h3>
                  <p className="text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Live tracking of filed issues</p>
                </div>
                <Link
                  to="/report"
              ...
              <div className="space-y-4">
                {reportsData.length > 0 ? (
                    ...
                    >
                      <div className="flex flex-wrap justify-between items-center gap-4 mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <h4 className="text-xl font-black text-slate-800 dark:text-white tracking-tight">{report.type}</h4>
                        </div>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-slate-50 dark:border-white/5">
                        <div className="flex items-center gap-2 text-slate-300 dark:text-slate-600">
                          <span className="text-[10px] font-bold uppercase tracking-widest">Filed: {report.date}</span>
                        </div>
                  ...
                  <div className="text-center py-24 bg-slate-50/50 dark:bg-white/5 rounded-[3rem] border-4 border-dashed border-white dark:border-white/5">
                    ...
                    <p className="text-slate-400 dark:text-slate-500 font-black uppercase tracking-widest text-[10px]">No activity logs found</p>
                  </div>
                )}
              </div>
            </div>
